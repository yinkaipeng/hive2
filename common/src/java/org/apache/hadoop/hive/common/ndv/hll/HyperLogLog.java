...
public class HyperLogLog implements NumDistinctValueEstimator{
  ...
  private final static ByteBuffer SHORT_BUFFER = ByteBuffer.allocate(Short.SIZE / Byte.SIZE);
  private final static ByteBuffer INT_BUFFER = ByteBuffer.allocate(Integer.SIZE / Byte.SIZE);
  private final static ByteBuffer LONG_BUFFER = ByteBuffer.allocate(Long.SIZE / Byte.SIZE);
