...
-- Table-Non-Cascade CHANGE COLUMNS ...
--** salter table table_change_numeric_group_string_group_multi_ints_varchar_trunc replace columns (insert_num int, c1 VARCHAR(5), c2 VARCHAR(5), c3 VARCHAR(5), c4 VARCHAR(5), b STRING) ;

--** sinsert into table table_change_numeric_group_string_group_multi_ints_varchar_trunc
--** s    values (5, '2000', '72909', '3244222', '-93222', 'new'),
--** s           (6, '1', '200', '2323322', '5430907', 'new'),
--** s           (7, '256', '32768', '31889', '470614135', 'new'),
--** s           (8, '5555', '40000', '-719017797', '810662019', 'new'),
--** s           (9, '100', '5000', '5443', '0', 'new'),
--** s           (10, '17', '90000', '754072151', '3289094', 'new');

--** sexplain
--** sselect insert_num,c1,c2,c3,c4,b from table_change_numeric_group_string_group_multi_ints_varchar_trunc order by insert_num;
