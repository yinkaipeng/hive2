...
public class DoubleColumnStatsAggregator extends ColumnStatsAggregator implements
  ...
  public ColumnStatisticsObj aggregate(List<ColStatsObjWithSourceInfo> colStatsWithSourceInfo,
    ...
    for (ColStatsObjWithSourceInfo csp : colStatsWithSourceInfo) {
      ...
      DoubleColumnStatsDataInspector doubleColumnStatsData = (DoubleColumnStatsDataInspector) cso
          .getStatsData().getDoubleStats();
    ...
    if (doAllPartitionContainStats || colStatsWithSourceInfo.size() < 2) {
      ...
      for (ColStatsObjWithSourceInfo csp : colStatsWithSourceInfo) {
        ColumnStatisticsObj cso = csp.getColStatsObj();
        DoubleColumnStatsDataInspector newData = (DoubleColumnStatsDataInspector) cso
            .getStatsData().getDoubleStats();
