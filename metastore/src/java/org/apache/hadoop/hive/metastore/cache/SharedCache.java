...
public class SharedCache {
  ...
  static class TableWrapper {
    ...
    public void updatePartitionColStats(List<String> partVal, List<ColumnStatisticsObj> colStatsObjs) {
      try {
        tableLock.writeLock().lock();
    ...
    private void addPartitionColStatsToCache(List<String> partVal, List<ColumnStatisticsObj> colStatsObjs) {
    ...
    public void refreshPartitionColStats(List<ColumnStatistics> partitionColStats) {
      ...
      try {
        tableLock.writeLock().lock();
        String tableName = HiveStringUtils.normalizeIdentifier(getTable().getTableName());
  ...
  public void populateDatabasesInCache(List<Database> databases) {
    for (Database db : databases) {
      ...
      try {
        ...
        databaseCache.putIfAbsent(HiveStringUtils.normalizeIdentifier(dbCopy.getName()), dbCopy);
  ...
  public void addDatabaseToCache(Database db) {
    try {
      ...
      // ObjectStore also stores db name in lowercase
      dbCopy.setName(dbCopy.getName().toLowerCase());
      databaseCache.put(HiveStringUtils.normalizeIdentifier(dbCopy.getName()), dbCopy);
  ...
  public void populateTableInCache(Table table, ColumnStatistics tableColStats, List<Partition> partitions,
      List<ColumnStatistics> partitionColStats, AggrStats aggrStatsAllPartitions,
      AggrStats aggrStatsAllButDefaultPartition) {
    String dbName = HiveStringUtils.normalizeIdentifier(table.getDbName());
    String tableName = HiveStringUtils.normalizeIdentifier(table.getTableName());
    // Since we allow write operations on cache while prewarm is happening:
  ...
  public List<String> listCachedTableNames(String dbName) {
    ...
    try {
      ...
      for (TableWrapper wrapper : tableCache.values()) {
        if (wrapper.getTable().getDbName().equals(dbName)) {
          tableNames.add(HiveStringUtils.normalizeIdentifier(wrapper.getTable().getTableName()));
        }
      }
    } finally {
      cacheLock.readLock().unlock();
  ...
  public List<ColumnStatisticsObj> getTableColStatsFromCache(String dbName, String tblName, List<String> colNames) {
    List<ColumnStatisticsObj> colStatObjs = new ArrayList<ColumnStatisticsObj>();
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
  ...
  public void updateTableColStatsInCache(String dbName, String tableName, List<ColumnStatisticsObj> colStatsForTable) {
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tableName));
      if (tblWrapper != null) {
  ...
  public void refreshTableColStatsInCache(String dbName, String tableName, List<ColumnStatisticsObj> colStatsForTable) {
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tableName));
      if (tblWrapper != null) {
  ...
  public Partition getPartitionFromCache(String dbName, String tblName, List<String> partVals) {
    Partition part = null;
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
  ...
  public Partition removePartitionFromCache(String dbName, String tblName, List<String> partVals) {
    Partition part = null;
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
  ...
  public void removePartitionsFromCache(String dbName, String tblName, List<List<String>> partVals) {
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
      if (tblWrapper != null) {
  ...
  public List<String> listCachedPartitionNames(String dbName, String tblName, int max) throws MetaException {
    List<Partition> parts = new ArrayList<>();
    List<String> partNames = new ArrayList<>();
    Table table = getTableFromCache(dbName, tblName);
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
      if (tblWrapper != null) {
  ...
  public void alterPartitionInCache(String dbName, String tblName, List<String> partVals, Partition newPart) {
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
      if (tblWrapper != null) {
  ...
  public void removePartitionColStatsFromCache(String dbName, String tblName, List<String> partVals, String colName) {
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
      if (tblWrapper != null) {
  ...
  public void updatePartitionColStatsInCache(String dbName, String tableName, List<String> partVals,
  ...
  public ColumnStatisticsObj getPartitionColStatsFromCache(String dbName, String tblName, List<String> partVal,
      String colName) {
  ...
  public void refreshPartitionColStatsInCache(String dbName, String tblName, List<ColumnStatistics> partitionColStats) {
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
      if (tblWrapper != null) {
  ...
  public List<ColumnStatisticsObj> getAggrStatsFromCache(String dbName, String tblName, List<String> colNames,
      StatsType statsType) {
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
  ...
  public void addAggregateStatsToCache(String dbName, String tblName, AggrStats aggrStatsAllPartitions,
      AggrStats aggrStatsAllButDefaultPartition) {
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
  ...
  public void refreshAggregateStatsInCache(String dbName, String tblName, AggrStats aggrStatsAllPartitions,
      AggrStats aggrStatsAllButDefaultPartition) {
    try {
      cacheLock.readLock().lock();
      TableWrapper tblWrapper = tableCache.get(CacheUtils.buildTableCacheKey(dbName, tblName));
