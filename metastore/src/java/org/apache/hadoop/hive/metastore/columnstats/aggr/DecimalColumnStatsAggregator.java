...
public class DecimalColumnStatsAggregator extends ColumnStatsAggregator implements
  ...
  public ColumnStatisticsObj aggregate(List<ColStatsObjWithSourceInfo> colStatsWithSourceInfo,
    ...
    for (ColStatsObjWithSourceInfo csp : colStatsWithSourceInfo) {
      ...
      DecimalColumnStatsDataInspector decimalColumnStatsData = (DecimalColumnStatsDataInspector) cso
          .getStatsData().getDecimalStats();
    ...
    if (doAllPartitionContainStats || colStatsWithSourceInfo.size() < 2) {
      ...
      for (ColStatsObjWithSourceInfo csp : colStatsWithSourceInfo) {
        ColumnStatisticsObj cso = csp.getColStatsObj();
        DecimalColumnStatsDataInspector newData = (DecimalColumnStatsDataInspector) cso
            .getStatsData().getDecimalStats();
