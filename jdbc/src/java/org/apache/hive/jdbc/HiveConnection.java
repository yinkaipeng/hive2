...
public class HiveConnection implements java.sql.Connection {
  ...
  private CloseableHttpClient getHttpClient(Boolean useSsl) throws SQLException {
    ...
    if (isKerberosAuthMode()) {
       ...
       */
      requestInterceptor = new HttpKerberosRequestInterceptor(sessConfMap.get(
          JdbcConnectionParams.AUTH_PRINCIPAL), host, getServerHttpUrl(useSsl), assumeSubject,
          cookieStore, cookieName, useSsl, additionalHttpHeaders, customCookies);
    } else {
